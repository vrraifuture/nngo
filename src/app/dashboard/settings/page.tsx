...
export default async function SettingsPage() {
              ...
              <CardContent>
                <div className="flex items-center gap-2 text-red-600 bg-red-100 p-4 rounded-lg">
                  ...
                  <div className="text-sm">
                    ...
                    <p>
                      Only users with administrator privileges can access system
                      settings. Contact your system administrator for access.
                    </p>
  ...
  function SettingsPageContent() {
    ...
    const [editingUserRole, setEditingUserRole] = useState<UserRole | null>(
      null,
    );
    ...
    const loadUserRole = async () => {
      try {
        ...
        if (error) {
          ...
          setUserRole(userRoleData?.role || "viewer");
        }
    ...
    const canManageCurrencies = () => {
      ...
      console.log(`canManageCurrencies: ${canManage} (role: ${userRole})`);
      return canManage;
    };

    const canManageProjects = () => {
      const canManage = userRole === "admin" || userRole === "project_manager";
      console.log(`canManageProjects: ${canManage} (role: ${userRole})`);
      return canManage;
    };

    const canManageDonors = () => {
      const canManage = userRole === "admin";
      console.log(`canManageDonors: ${canManage} (role: ${userRole})`);
      return canManage;
    };
    ...
    const canManageBudgetCategories = () => {
      const canManage = userRole === "admin" || userRole === "accountant";
      console.log(
        `canManageBudgetCategories: ${canManage} (role: ${userRole})`,
      );
      return canManage;
    };
    ...
    const canManageChartOfAccounts = () => {
      const canManage = userRole === "admin" || userRole === "accountant";
      console.log(`canManageChartOfAccounts: ${canManage} (role: ${userRole})`);
      return canManage;
    };

    const canManagePaymentMethods = () => {
      const canManage = userRole === "admin" || userRole === "accountant";
      console.log(`canManagePaymentMethods: ${canManage} (role: ${userRole})`);
      return canManage;
    };

    const canManageRoles = () => {
      const canManage = userRole === "admin";
      console.log(`canManageRoles: ${canManage} (role: ${userRole})`);
      return canManage;
    };

    const canManageUsers = () => {
      const canManage = userRole === "admin";
      console.log(`canManageUsers: ${canManage} (role: ${userRole})`);
      return canManage;
    };

    const canViewSection = (section: string) => {
      console.log(
        `Checking view permission for section: ${section}, userRole: ${userRole}`,
      );

      switch (section) {
        case "currencies":
          const canViewCurrencies =
            canManageCurrencies() || userRole === "project_manager";
          console.log(`Can view currencies: ${canViewCurrencies}`);
          return canViewCurrencies;
        case "projects":
          const canViewProjects =
            canManageProjects() || userRole === "accountant";
        ...
        <CardContent>
          <div className="flex items-center gap-2 text-red-600 bg-red-100 p-4 rounded-lg">
            ...
            <div className="text-sm">
              ...
              <p>
                You don't have permission to access this section. Contact your
          ...
          <div className="container mx-auto px-4 py-8 flex flex-col gap-8">
            ...
            <header className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-3">
                <div className="bg-red-100 text-red-800 px-3 py-1 rounded-full text-sm font-medium capitalize">
                ...
                <CardHeader>
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <CardDescription>
                        Add new users, send invitations, and manage user
                        accounts
                      </CardDescription>
                    </div>
                    {canManageUsers() && (
                            ...
                            <div className="bg-blue-50 p-4 rounded-lg">
                              ...
                              <div className="text-sm text-blue-800 space-y-1">
                                ...
                                {selectedRole === "project_manager" && (
                                  <ul className="list-disc list-inside space-y-1">
                                    <li>
                                      Manage assigned projects and budgets
                                    </li>
                                ...
                                {selectedRole === "donor" && (
                                  <ul className="list-disc list-inside space-y-1">
                                    ...
                                    <li>
                                      Access to funded project information
                                    </li>
                ...
                {changingPasswordUser && (
                  <div className="space-y-4">
                    ...
                    <div className="bg-yellow-50 p-4 rounded-lg">
                      ...
                      <div className="text-sm text-yellow-800 space-y-1">
                        <p>
                          • The user will be able to sign in immediately with
                          the new password
                        </p>
